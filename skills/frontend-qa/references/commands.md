...
# risk-register.md/json and risk-acceptance.md/json are written by qa; read result.json.riskRegister/riskAcceptance for release risks and acceptance decisions
