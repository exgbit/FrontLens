...
- Keep core safe scan mandatory: page load, screenshot/DOM snapshot, page model, Console/Network collection, safe interaction discovery, reports, issue fingerprints, issueDisposition, rootCauseGroups, defectProof, defectTickets, traceability, proof-aware fixTasks, and mutating request blocking.
