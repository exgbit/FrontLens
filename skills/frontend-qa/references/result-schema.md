...
`regressionPlan` is the machine-readable post-fix verification plan. It converts root causes, failed requirements/journeys, source-health blockers, download/export evidence, artifact integrity, environment trust, pageProfile/scopeReview/claimGuard gaps, and test-data gaps into rerun commands and focused verification items.
