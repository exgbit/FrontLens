...
# risk-register.md/json are written by qa; read result.json.riskRegister for release risks
...
node dist/cli.js qa-plan --report "reports/frontlens/users/result.json"
node dist/cli.js qa-coverage --report "reports/frontlens/users/result.json"
# then inspect reports/frontlens/users/risk-register.md or result.json.riskRegister
```
...
node dist/cli.js qa-plan --report "reports/frontlens/users/result.json"
node dist/cli.js qa-coverage --report "reports/frontlens/users/result.json"
# no separate CLI is needed for riskRegister; inspect risk-register.md/json or result.json.riskRegister
