...
Use FrontLens to analyze a target webpage end-to-end and return four primary artifacts:
...
- `regressionPlan`
- `aiAnalysis`
- `artifacts.markdownReport` / `artifacts.qaReview` / `artifacts.evidenceReport`
