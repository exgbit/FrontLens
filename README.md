...
- 面向修复排期的 `brief.md` / `professional-audit.md` / `qa-plan.md` / `qa-coverage.md` / `product-context.md` / `product-context.config.json` / `report.md` / `qa-review.md` 精简专业复盘、`evidence-report.md` 原始证据附录与 `regression-plan.json` 回归复测清单
