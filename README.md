...
- **代码负责取证与收敛**：浏览器自动化、截图、网络记录、异常模拟、Coverage、安全扫描、JSON/Markdown 报告生成，以及 `report.md` / `qa-review.md` 专业复盘摘要，并生成 `scope-review.md` 把产品/PRD 缺口转成可回答的问题。
