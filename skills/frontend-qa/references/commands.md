...
# assertion-suggestions.md/json, test-cases.md/json, risk-register.md/json, and risk-acceptance.md/json are written by qa; read result.json.assertionSuggestions/testCases/riskRegister/riskAcceptance for formal test execution, release risks, and acceptance decisions
...
node dist/cli.js assertion-suggestions --report "reports/frontlens/users/result.json"
node dist/cli.js test-cases --report "reports/frontlens/users/result.json"
# then inspect reports/frontlens/users/assertion-suggestions.md, test-cases.md, risk-register.md or result.json.assertionSuggestions/testCases/riskRegister
```
...
node dist/cli.js assertion-suggestions --report "reports/frontlens/users/result.json"
node dist/cli.js test-cases --report "reports/frontlens/users/result.json"
# riskRegister/riskAcceptance also have Markdown/JSON artifacts; inspect risk-register.md/json, risk-acceptance.md/json, or result.json
