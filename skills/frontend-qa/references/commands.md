...
# test-cases.md/json, risk-register.md/json, and risk-acceptance.md/json are written by qa; read result.json.testCases/riskRegister/riskAcceptance for formal test execution, release risks, and acceptance decisions
...
node dist/cli.js qa-coverage --report "reports/frontlens/users/result.json"
node dist/cli.js test-cases --report "reports/frontlens/users/result.json"
# then inspect reports/frontlens/users/test-cases.md, risk-register.md or result.json.testCases/riskRegister
```
