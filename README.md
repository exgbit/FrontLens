...
# qa-intake、assertion-suggestions、test-cases、risk-register、risk-acceptance、artifact-integrity 均由 qa 自动生成或可通过 helper 重算，也可直接读 result.json.qaIntake / assertionSuggestions / testCases / riskRegister / riskAcceptance / artifactIntegrity
